...
date: 2026-06-29
description: "Most research questions are answered by waiting well, not reading harder — a case for persistent, budgeted micro-researchers."
---
...
**Deep research agents** proved the capability. [OpenAI's Deep Research](https://openai.com/index/introducing-deep-research/), RL-trained end-to-end on browsing tasks, scored 26.6% on Humanity's Last Exam against roughly 9% for o1 — a real jump that arrived together with the citation pathologies quantified at the top of this essay. But it is burst-shaped by construction: one question, one spike of compute, one disposable report.
